  ...
  return (
    <div className="relative overflow-hidden bg-white rounded-2xl border border-[#e5e7eb] p-5 group hover:shadow-lg hover:border-[#de1b23]/15 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-500">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {/* Open button — links to the live OpenClaw web interface on the agent's server */}
        {status === "running" && subdomain ? (
          <a
            href={`https://${subdomain}`}
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 rounded-xl bg-[#1a1a2e] text-white text-xs font-semibold hover:bg-[#2d2d44] hover:shadow-md transition-all duration-300 flex items-center gap-1.5"
          >
            {t("agents", "openGateway")}
